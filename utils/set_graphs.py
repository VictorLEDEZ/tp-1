...
def plot_results(signal_number, errors_1, errors_2, all_mu_1, all_sigma_1, all_mu_2, all_sigma_2):
    ...
    axs[0, 0].plot(errors_1[0])
    axs[0, 0].plot(errors_2[0], 'r')
    axs[0, 0].set_title(title(all_mu_1[0], all_sigma_1[0], all_mu_2[0], all_sigma_2[0]))
    axs[0, 0].set(ylabel = str(round(errors_1[0][-1], 3)))

    axs[0, 1].plot(errors_1[1])
    axs[0, 1].plot(errors_2[1], 'r')
    axs[0, 1].set_title(title(all_mu_1[1], all_sigma_1[1], all_mu_2[1], all_sigma_2[1]))
    axs[0, 1].set(ylabel = str(round(errors_1[1][-1], 3)))

    axs[1, 0].plot(errors_1[2])
    axs[1, 0].plot(errors_2[2], 'r')
    axs[1, 0].set_title(title(all_mu_1[2], all_sigma_1[2], all_mu_2[2], all_sigma_2[2]))
    axs[1, 0].set(ylabel = str(round(errors_1[2][-1], 3)))

    axs[1, 1].plot(errors_1[3])
    axs[1, 1].plot(errors_2[3], 'r')
    axs[1, 1].set_title(title(all_mu_1[3], all_sigma_1[3], all_mu_2[3], all_sigma_2[3]))
    axs[1, 1].set(ylabel = str(round(errors_1[3][-1], 3)))

    axs[2, 0].plot(errors_1[4])
    axs[2, 0].plot(errors_2[4], 'r')
    axs[2, 0].set_title(title(all_mu_1[4], all_sigma_1[4], all_mu_2[4], all_sigma_2[4]))
    axs[2, 0].set(ylabel = str(round(errors_1[4][-1], 3)))
